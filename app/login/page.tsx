      ...
      {sent ? (
        ...
        <Card className="w-full max-w-sm bg-card/60 backdrop-blur-md">
          <CardContent className="p-8 space-y-6">
            ...
            <div className="flex items-start gap-2 rounded-lg bg-muted/40 border border-border/60 px-3 py-2.5 text-xs text-muted-foreground">
              <Lock className="size-3.5 mt-0.5 shrink-0 text-foreground/70" />
              <p>
                Twój adres e-mail nie będzie publicznie widoczny. Używamy go
                wyłącznie do logowania i ewentualnego kontaktu
                z administratorem.
              </p>
            </div>
          </CardContent>
